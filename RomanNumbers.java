public enum RomanNumbers {
    ...
    final int translationToArabic;

    RomanNumbers(int translationToArabic) {
        this.translationToArabic = translationToArabic;
    }

    public int getTranslationToArabic() {
        return translationToArabic;
    }
}
